            ...
            <div class="d-flex flex-wrap align-items-center justify-content-between gap-3">
                ...
                <div class="d-flex gap-2">
                    ...
                    <a href="{{ route('assets.create') }}" class="btn btn-outline-light btn-sm fw-semibold">
                        <i class="bi bi-plus-lg me-1"></i>Usulan Aset
                    </a>
                </div>
            </div>
        </div>
    ...
    <div class="row g-3 mb-4">
        @php
            $cards = [
                ...
                [
                    'label' => 'Aset Disetujui',
                    'value' => $statistics['approved_assets'],
                    'icon' => 'check-circle',
                    'color' => 'info',
                    'route' => 'assets.index',
                ...
                [
                    ...
                    'value' => $statistics['pending_assets'],
                            ...
                            <tbody>
                                @forelse ($recentAssets as $asset)
                                    <tr>
                                        ...
                                        <td class="text-end pe-4">
                                            @php
                                                $statusClass = $asset->status === 'Disetujui' ? 'success' : 'warning';
                                            @endphp
                                            <span
                                                class="badge rounded-pill bg-{{ $statusClass }}-subtle text-{{ $statusClass }}">
                                                <i class="bi bi-circle-fill me-1"
                                                    style="font-size: .5rem;"></i>{{ $asset->status ?? '-' }}
                                            </span>
                                        </td>
                                    </tr>
                                @empty
