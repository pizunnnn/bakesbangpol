...
@section('title', 'Edit Katalog Barang')
            ...
            <form action="{{ route('catalog.update', $catalog) }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="kode_barang" class="form-control @error('kode_barang') is-invalid @enderror"
                        placeholder="Contoh: 1.3.2.05.01.01.001" value="{{ old('kode_barang', $catalog->kode_barang) }}"
                        required>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="nama_barang" class="form-control @error('nama_barang') is-invalid @enderror"
                        ...
                        value="{{ old('nama_barang', $catalog->nama_barang) }}" required>
                    @error('nama_barang')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
