...
@section('content')
    <div class="d-flex align-items-center justify-content-between mb-4 flex-wrap gap-2">
        <div>
            ...
            <p class="text-muted mb-0">Perbarui data pegawai <strong>{{ $employee->full_name }}</strong>.</p>
        </div>
            ...
            <form action="{{ route('employees.update', $employee) }}" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="employee_number" id="employee_number" class="form-control @error('employee_number') is-invalid @enderror" value="{{ old('employee_number', $employee->employee_number) }}">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" name="birth_place" class="form-control @error('birth_place') is-invalid @enderror" value="{{ old('birth_place', $employee->birth_place) }}">
                        @error('birth_place')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="col-md-4 mb-3">
                        ...
                        <div class="input-group">
                            <input type="text" name="birth_date" id="birth_date" class="form-control flatpickr @error('birth_date') is-invalid @enderror" value="{{ old('birth_date', $employee->birth_date ? $employee->birth_date->format('Y-m-d') : '') }}">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <select name="status_pegawai" id="status_pegawai" class="form-select @error('status_pegawai') is-invalid @enderror" required>
                            ...
                            <option value="PNS" {{ old('status_pegawai', $employee->status_pegawai) == 'PNS' ? 'selected' : '' }}>PNS (Pegawai Negeri Sipil)</option>
                            <option value="PPPK" {{ old('status_pegawai', $employee->status_pegawai) == 'PPPK' ? 'selected' : '' }}>PPPK (Pegawai Pemerintah dengan Perjanjian Kerja)</option>
                            <option value="PPPK Paruh Waktu" {{ old('status_pegawai', $employee->status_pegawai) == 'PPPK Paruh Waktu' ? 'selected' : '' }}>PPPK Paruh Waktu</option>
                        </select>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="pangkat_golongan" class="form-control @error('pangkat_golongan') is-invalid @enderror" value="{{ old('pangkat_golongan', $employee->pangkat_golongan) }}" placeholder="Contoh: Penata Muda / III/a">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="input-group">
                            <input type="text" name="join_date" id="join_date" class="form-control flatpickr @error('join_date') is-invalid @enderror" value="{{ old('join_date', $employee->join_date ? $employee->join_date->format('Y-m-d') : '') }}">
