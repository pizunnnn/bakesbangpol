                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <select name="status_pegawai" id="status_pegawai"
                            ...
                            <option value="Pegawai Tetap" {{ old('status_pegawai') == 'Pegawai Tetap' ? 'selected' : '' }}>
                                Pegawai Tetap (PNS)</option>
                            <option value="P3K Paruh Waktu"
                                {{ old('status_pegawai') == 'P3K Paruh Waktu' ? 'selected' : '' }}>
                                P3K Paruh Waktu</option>
                            <option value="Outsourcing" {{ old('status_pegawai') == 'Outsourcing' ? 'selected' : '' }}>
                                Outsourcing</option>
                        </select>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select name="employment_status"
                            ...
                            <option value="active" {{ old('employment_status') == 'active' ? 'selected' : '' }}>Aktif
                            </option>
                            <option value="inactive" {{ old('employment_status') == 'inactive' ? 'selected' : '' }}>Tidak
                                Aktif</option>
                        </select>
                        ...
                        <select name="unit_kerja" id="unit_kerja"
                            ...
                            @foreach ($departments as $department)
                                <option value="{{ $department->code }}"
                                    {{ old('unit_kerja') == $department->code ? 'selected' : '' }}>
