                ...
                <div class="d-flex gap-2 flex-wrap align-items-center">
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end shadow-sm" style="min-width: 280px;">
                            ...
                            <li>
                                <a class="dropdown-item fw-semibold text-info py-2" href="{{ route('assets.export-pdf', array_merge(request()->query(), ['mode' => 'detail', 'status' => 'eligible_10_years'])) }}" target="_blank">
                                    <i class="bi bi-file-earmark-text me-2 fs-6"></i>Preview PDF Rincian Aset
                                </a>
                            </li>
                            <li><hr class="dropdown-divider"></li>
                            <li>
                                <a class="dropdown-item fw-semibold text-success py-2" href="{{ route('assets.export-excel', array_merge(request()->query(), ['status' => 'eligible_10_years'])) }}">
