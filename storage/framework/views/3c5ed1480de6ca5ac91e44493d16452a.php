                ...
                <div class="d-flex gap-2 flex-wrap align-items-center">
                    <div class="dropdown">
                        <button class="btn btn-sm btn-outline-success dropdown-toggle d-inline-flex align-items-center fw-bold" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                            <i class="bi bi-printer me-1"></i>Export / Cetak
                        </button>
                        <ul class="dropdown-menu dropdown-menu-end shadow-sm" style="min-width: 280px;">
                            <li>
                                <a class="dropdown-item fw-semibold text-primary py-2" href="<?php echo e(route('assets.print-preview', array_merge(request()->query(), ['mode' => 'detail', 'status' => 'eligible_10_years']))); ?>" target="_blank">
                            ...
                            <li>
                                <a class="dropdown-item fw-semibold text-info py-2" href="<?php echo e(route('assets.export-pdf', array_merge(request()->query(), ['mode' => 'detail', 'status' => 'eligible_10_years']))); ?>" target="_blank">
                                    <i class="bi bi-file-earmark-text me-2 fs-6"></i>Preview PDF Rincian Aset
                                </a>
                            </li>
                            <li><hr class="dropdown-divider"></li>
                            <li>
                                <a class="dropdown-item fw-semibold text-success py-2" href="<?php echo e(route('assets.export-excel', array_merge(request()->query(), ['status' => 'eligible_10_years']))); ?>">
