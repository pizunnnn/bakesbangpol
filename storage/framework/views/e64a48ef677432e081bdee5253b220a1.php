...
<head>
    ...
    <title>Surat Keterangan Hak Tunjangan - <?php echo e($employee->full_name); ?></title>
...
<body>
    ...
    <div class="container my-3 no-print">
        <div class="d-flex justify-content-between align-items-center">
            <a href="<?php echo e(route('employees.show', ['employee' => $employee, 'tab' => 'allowance'])); ?>" class="btn btn-sm btn-outline-secondary">
    ...
    <div class="slip-container">
        ...
        <div class="doc-name">
            ...
            <p>Nomor: 800 / SKT / BAKESBANGPOL / <?php echo e(date('Y')); ?></p>
        </div>
        ...
        <div class="card bg-light border rounded-3 p-3 mb-4">
            <table class="table table-borderless table-sm mb-0" style="font-size: 12px;">
                <tr>
                    ...
                    <td style="width: 260px;">: <strong><?php echo e($employee->full_name); ?></strong></td>
                    <td style="width: 140px;" class="text-muted">NPWP</td>
                    <td>: <strong><?php echo e($allowance->npwp ?? '-'); ?></strong></td>
                </tr>
                <tr>
                    <td class="text-muted">NIP / Status Pegawai</td>
                    <td>: <?php echo e($employee->employee_number); ?> (<strong><?php echo e($employee->status_pegawai); ?></strong>)</td>
                    <td class="text-muted">Rekening Bank</td>
                    <td>: <strong><?php echo e($allowance->nomor_rekening ?? '-'); ?></strong> (<?php echo e($allowance->nama_bank ?? 'Bank bjb'); ?>)</td>
                </tr>
                <tr>
                    <td class="text-muted">Pangkat / Golongan</td>
                    <td>: <?php echo e($employee->pangkat_golongan ?: '-'); ?></td>
                    <td class="text-muted">Status / Tanggungan</td>
                    <td>: Status <strong><?php echo e(($allowance && $allowance->status_kawin === 'K') ? 'Kawin' : 'Tidak Kawin'); ?></strong> | Kode: <strong><?php echo e($allowance->kd_jiwa ?? '1100'); ?></strong> (<strong><?php echo e($allowance->jml_jiwa ?? 1); ?> Jiwa</strong>)</td>
                </tr>
                <tr>
                    <td class="text-muted">Jabatan / Unit Kerja</td>
                    <td>: <?php echo e($employee->position->name ?? $employee->unit_kerja ?? '-'); ?></td>
                    <td class="text-muted">Masa Kerja (Masker)</td>
                    <td>: <strong><?php echo e($allowance->masker ?? $employee->masa_kerja_tahun ?? '-'); ?> Tahun</strong> | TMT: <?php echo e($allowance && $allowance->tmt_sk ? $allowance->tmt_sk->format('d/m/Y') : '-'); ?></td>
                </tr>
            </table>
        </div>
            ...
            <tbody>
                <tr>
                    ...
                    <td class="text-center">
                        <?php if($allowance?->has_tj_suami_istri): ?>
                            <span class="badge bg-success">Berhak Menerima</span>
                        <?php else: ?>
                            <span class="badge bg-secondary">Tidak Menerima</span>
                        <?php endif; ?>
                    </td>
                    <td><?php echo e($allowance?->has_tj_suami_istri ? 'Pegawai berstatus Kawin (1 Pasangan Sah)' : 'Tidak berstatus kawin / tidak ada tanggungan pasangan'); ?></td>
                </tr>
                <tr>
                    <td class="text-center">2</td>
                    <td><strong>Tunjangan Anak</strong></td>
                    <td class="text-center">
                        <?php if($allowance?->has_tj_anak): ?>
                            <span class="badge bg-info text-dark">Berhak (<?php echo e($allowance->jumlah_anak_tanggungan); ?> Anak)</span>
                        <?php else: ?>
                            <span class="badge bg-secondary">Tidak Menerima</span>
                        <?php endif; ?>
                    </td>
                    <td><?php echo e($allowance?->has_tj_anak ? 'Tanggungan ' . $allowance->jumlah_anak_tanggungan . ' anak kandung/sah memenuhi syarat usia & sekolah' : 'Tidak ada anak tanggungan'); ?></td>
                </tr>
                <tr>
                    <td class="text-center">3</td>
                    <td><strong>Tunjangan Jabatan Struktural</strong></td>
                    <td class="text-center">
                        <?php if($allowance?->has_tj_struktural): ?>
                            <span class="badge bg-warning text-dark">Pejabat Struktural</span>
                        <?php else: ?>
                            <span class="badge bg-secondary">Bukan Struktural</span>
                        <?php endif; ?>
                    </td>
                    <td><?php echo e($allowance?->has_tj_struktural ? 'Menduduki jabatan struktural (' . ($employee->position->name ?? 'Eselon') . ')' : 'Tidak menduduki jabatan struktural'); ?></td>
                </tr>
                <tr>
                    <td class="text-center">4</td>
                    <td><strong>Tunjangan Jabatan Fungsional</strong></td>
                    <td class="text-center">
                        <?php if($allowance?->has_tj_fungsional): ?>
                            <span class="badge bg-primary text-white">Pejabat Fungsional</span>
                        <?php else: ?>
                            <span class="badge bg-secondary">-</span>
                        <?php endif; ?>
                    </td>
                    <td><?php echo e($allowance?->has_tj_fungsional ? 'Menduduki jabatan fungsional tertentu/keahlian' : 'Bukan jabatan fungsional tertentu'); ?></td>
                </tr>
                <tr>
                    <td class="text-center">5</td>
                    <td><strong>Tunjangan Beras</strong></td>
                    <td class="text-center">
                        <span class="badge bg-success">Berhak (<?php echo e($allowance->jml_jiwa ?? 1); ?> Jiwa)</span>
                    </td>
                    <td>Tunjangan pangan beras untuk <?php echo e($allowance->jml_jiwa ?? 1); ?> jiwa keluarga yang terdaftar dalam Kartu Keluarga / SIMPEG</td>
                </tr>
                <tr>
...
</html><?php /**PATH D:\BakesBangPol\KesbangPol\resources\views/employees/allowances/slip_print.blade.php ENDPATH**/ ?>