...
<body>
    ...
    <div class="doc-title">
        ...
        <p>
            <?php if($statusPegawai): ?> Filter Status: <strong><?php echo e($statusPegawai); ?></strong> | <?php endif; ?>
            <?php if($filterUnit): ?> Unit Kerja: <strong><?php echo e($filterUnit); ?></strong> | <?php endif; ?>
            <?php if($filterJabatan): ?> Jabatan: <strong><?php echo e($filterJabatan); ?></strong> | <?php endif; ?>
        ...
        <tbody>
            <?php $__empty_1 = true; $__currentLoopData = $employees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $emp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr>
                    ...
                    <td class="text-center"><?php echo e($emp->status_pegawai); ?></td>
                    <td class="text-center"><?php echo e($emp->pangkat_golongan ?: '-'); ?></td>
                    <td><?php echo e($emp->position->name ?? '-'); ?></td>
                    <td><?php echo e($emp->unit_kerja ?: $emp->department->name ?? '-'); ?></td>
                    <td class="text-center"><?php echo e($emp->join_date ? $emp->join_date->format('d/m/Y') : '-'); ?></td>
                    <td class="text-center"><?php echo e($emp->masa_kerja); ?></td>
                </tr>
...
<?php /**PATH D:\BakesBangPol\KesbangPol\resources\views/employees/pdf.blade.php ENDPATH**/ ?>