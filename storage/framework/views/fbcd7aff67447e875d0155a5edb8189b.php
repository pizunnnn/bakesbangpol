...
<?php $__env->startSection('content'); ?>
    <div class="d-flex align-items-center justify-content-between mb-4 flex-wrap gap-2">
        <div>
            ...
            <p class="text-muted mb-0"><?php echo e($employee->full_name); ?></p>
        </div>
...
unset($__errorArgs, $__bag); ?>"
                            value="<?php echo e(old('full_name', $employee->full_name)); ?>" required>
...
unset($__errorArgs, $__bag); ?>"
                            value="<?php echo e(old('employee_number', $employee->employee_number)); ?>">
...
unset($__errorArgs, $__bag); ?>"
                            ...
                            <option value="Pegawai Tetap"
                                <?php echo e(old('status_pegawai', $employee->status_pegawai) == 'Pegawai Tetap' ? 'selected' : ''); ?>>
                                Pegawai Tetap (PNS)</option>
                            <option value="P3K Paruh Waktu"
                                <?php echo e(old('status_pegawai', $employee->status_pegawai) == 'P3K Paruh Waktu' ? 'selected' : ''); ?>>
                                P3K Paruh Waktu</option>
                            <option value="Outsourcing"
                                <?php echo e(old('status_pegawai', $employee->status_pegawai) == 'Outsourcing' ? 'selected' : ''); ?>>
                                Outsourcing</option>
                        </select>
...
unset($__errorArgs, $__bag); ?>">
                            <option value="active"
                                <?php echo e(old('employment_status', $employee->employment_status) == 'active' ? 'selected' : ''); ?>>
                                Aktif</option>
                            <option value="inactive"
                                <?php echo e(old('employment_status', $employee->employment_status) == 'inactive' ? 'selected' : ''); ?>>
                                Tidak Aktif</option>
                        </select>
...
unset($__errorArgs, $__bag); ?>">
                            ...
                            <?php $__currentLoopData = $departments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $department): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($department->code); ?>"
                                    <?php echo e(old('unit_kerja', $employee->unit_kerja) == $department->code ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>">
                            ...
                            <?php $__currentLoopData = $positions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $position): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($position->id); ?>"
                                    <?php echo e(old('position_id', $employee->position_id) == $position->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>"
                            value="<?php echo e(old('join_date', $employee->join_date ? $employee->join_date->format('Y-m-d') : '')); ?>"
                            placeholder="DD/MM/YYYY">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\bakesbangpol\resources\views/employees/edit.blade.php ENDPATH**/ ?>