            ...
            <div class="d-flex flex-wrap align-items-center justify-content-between gap-3">
                <div>
                    ...
                    <p class="text-white-50 mb-0">
                        Ringkasan data Kepegawaian & Manajemen Aset Bakesbangpol pada <?php echo e(now()->translatedFormat('l, d F Y')); ?>
        ...
        <?php $__currentLoopData = $cards; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $card): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="col-12 col-sm-6 col-xl">
                <a href="<?php echo e(route($card['route'])); ?>" class="text-decoration-none">
                    <div class="stat-card rounded-4 p-3 h-100 d-flex align-items-center gap-3 cursor-pointer" style="background: <?php echo e($card['gradient']); ?>;">
        ...
        <div class="col-md-3">
            <a href="<?php echo e(route('assets.deletable')); ?>" class="text-decoration-none">
                <div class="card shadow-sm border-0 rounded-4 p-3 bg-danger text-white h-100">
                    ...
                    <div class="fs-3 fw-bold"><?php echo e($statistics['aged_assets']); ?> <small class="fs-6 fw-normal">Unit</small></div>
        ...
        <div class="col-md-3">
            <a href="<?php echo e(route('assets.index')); ?>" class="text-decoration-none">
                <div class="card shadow-sm border-0 rounded-4 p-3 bg-primary text-white h-100">
                    ...
                    <div class="fs-3 fw-bold"><?php echo e($statistics['total_maintenances']); ?> <small class="fs-6 fw-normal">Kegiatan</small></div>
                    <small class="text-white-50">Total Biaya: Rp <?php echo e(number_format((float)$statistics['total_maintenance_cost'], 0, ',', '.')); ?></small>
                </div>
            </a>
        </div>
        <div class="col-md-3">
            <a href="<?php echo e(route('assets.index')); ?>" class="text-decoration-none">
                <div class="card shadow-sm border-0 rounded-4 p-3 bg-dark text-white h-100">
                    ...
                    <div class="fs-3 fw-bold"><?php echo e($statistics['total_vehicles']); ?> <small class="fs-6 fw-normal">Unit</small></div>
                    <small class="text-white-50">Dalam Perbaikan: <?php echo e($statistics['vehicles_in_repair']); ?> Unit</small>
                </div>
            </a>
        </div>
        <div class="col-md-3">
            <a href="<?php echo e(route('reviews.index')); ?>" class="text-decoration-none">
                <div class="card shadow-sm border-0 rounded-4 p-3 bg-secondary text-white h-100">
                    ...
                    <div class="fs-3 fw-bold"><?php echo e($statistics['total_reviews']); ?> <small class="fs-6 fw-normal">Laporan</small></div>
                                ...
                                <?php $__empty_1 = true; $__currentLoopData = $recentEmployees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $employee): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        ...
                                        <td class="text-end pe-4">
                                            <span class="badge rounded-pill text-bg-light border"><?php echo e($employee->position?->name ?? '-'); ?></span>
                                        </td>
                                    </tr>
                        ...
                        <table class="table table-hover align-middle mb-0">
                            ...
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $recentAssets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $asset): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        <td class="ps-4 fw-medium"><?php echo e($asset->nama_barang ?? ($asset->category ?? '-')); ?></td>
