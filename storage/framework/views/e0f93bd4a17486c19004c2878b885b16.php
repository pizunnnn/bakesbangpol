...
<?php $__env->startSection('title', 'Edit Katalog Barang'); ?>

<?php $__env->startSection('content'); ?>
    <div class="d-flex align-items-center justify-content-between mb-4 flex-wrap gap-2">
        <div>
            <h1 class="h3 mb-1">Edit Katalog Barang</h1>
            <p class="text-muted mb-0">Perbarui kategori & kode barang</p>
        </div>
    ...
    <div class="card shadow-sm border-0 rounded-4">
        ...
        <div class="card-body">
            <form action="<?php echo e(route('catalog.update', $catalog)); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                        placeholder="Contoh: 1.3.2.05.01.01.001" value="<?php echo e(old('kode_barang', $catalog->kode_barang)); ?>"
                        required>
...
unset($__errorArgs, $__bag); ?>"
                        placeholder="Contoh: Personal Computer / Laptop"
                        value="<?php echo e(old('nama_barang', $catalog->nama_barang)); ?>" required>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\bakesbangpol\resources\views\catalog\edit.blade.php ENDPATH**/ ?>