...
<?php $__env->startSection('content'); ?>
    <div class="d-flex align-items-center justify-content-between mb-4 flex-wrap gap-2">
        <div>
            <h1 class="h3 mb-1 fw-bold text-primary">Edit Data Pegawai</h1>
            <p class="text-muted mb-0">Perbarui data pegawai <strong><?php echo e($employee->full_name); ?></strong>.</p>
        </div>
    ...
    <div class="card shadow-sm border-0 rounded-4">
        <div class="card-header bg-warning text-dark fw-bold rounded-4 rounded-bottom-0 py-3">
            <i class="bi bi-pencil-square me-2"></i>Form Edit Data Pegawai
        </div>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('full_name', $employee->full_name)); ?>" required>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('employee_number', $employee->employee_number)); ?>">
...
unset($__errorArgs, $__bag); ?>">
                            ...
                            <option value="male" <?php echo e(old('gender', $employee->gender) == 'male' ? 'selected' : ''); ?>>Laki-laki</option>
                            <option value="female" <?php echo e(old('gender', $employee->gender) == 'female' ? 'selected' : ''); ?>>Perempuan</option>
                        </select>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('birth_place', $employee->birth_place)); ?>">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('birth_date', $employee->birth_date ? $employee->birth_date->format('Y-m-d') : '')); ?>">
...
unset($__errorArgs, $__bag); ?>" rows="2"><?php echo e(old('address', $employee->address)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" required>
                            ...
                            <option value="PNS" <?php echo e(old('status_pegawai', $employee->status_pegawai) == 'PNS' ? 'selected' : ''); ?>>PNS (Pegawai Negeri Sipil)</option>
                            <option value="PPPK" <?php echo e(old('status_pegawai', $employee->status_pegawai) == 'PPPK' ? 'selected' : ''); ?>>PPPK (Pegawai Pemerintah dengan Perjanjian Kerja)</option>
                            <option value="PPPK Paruh Waktu" <?php echo e(old('status_pegawai', $employee->status_pegawai) == 'PPPK Paruh Waktu' ? 'selected' : ''); ?>>PPPK Paruh Waktu</option>
                        </select>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('pangkat_golongan', $employee->pangkat_golongan)); ?>" placeholder="Contoh: Penata Muda / III/a">
...
unset($__errorArgs, $__bag); ?>">
                            ...
                            <?php $__currentLoopData = $positions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $position): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($position->id); ?>" <?php echo e(old('position_id', $employee->position_id) == $position->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('join_date', $employee->join_date ? $employee->join_date->format('Y-m-d') : '')); ?>">
...
unset($__errorArgs, $__bag); ?>">
                            <option value="active" <?php echo e(old('employment_status', $employee->employment_status) == 'active' ? 'selected' : ''); ?>>Aktif</option>
                            <option value="inactive" <?php echo e(old('employment_status', $employee->employment_status) == 'inactive' ? 'selected' : ''); ?>>Tidak Aktif</option>
                        </select>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\BakesBangPol\KesbangPol\resources\views/employees/edit.blade.php ENDPATH**/ ?>