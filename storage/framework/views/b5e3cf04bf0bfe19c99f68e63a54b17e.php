        ...
        <div class="card-body">
            <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap gap-2">
                ...
                <div class="d-flex gap-2 flex-wrap align-items-center">
                    ...
                    <a href="<?php echo e(route('employees.create')); ?>" class="btn btn-sm btn-primary d-inline-flex align-items-center">
            ...
            <div class="mb-3 d-flex gap-1 flex-wrap align-items-center">
                ...
                <a href="<?php echo e(route('employees.export-pdf', ['status_pegawai' => 'PNS'])); ?>" target="_blank" class="badge bg-primary text-decoration-none px-2 py-1">
                    <i class="bi bi-printer me-1"></i>Cetak PNS
                </a>
                <a href="<?php echo e(route('employees.export-pdf', ['status_pegawai' => 'PPPK'])); ?>" target="_blank" class="badge bg-success text-decoration-none px-2 py-1">
                    <i class="bi bi-printer me-1"></i>Cetak PPPK
                </a>
                <a href="<?php echo e(route('employees.export-pdf', ['status_pegawai' => 'PPPK Paruh Waktu'])); ?>" target="_blank" class="badge bg-info text-decoration-none px-2 py-1">
                    <i class="bi bi-printer me-1"></i>Cetak PPPK Paruh Waktu
                </a>
                <a href="<?php echo e(route('employees.export-pdf')); ?>" target="_blank" class="badge bg-secondary text-decoration-none px-2 py-1">
                    <i class="bi bi-printer me-1"></i>Cetak Seluruh Pegawai
                </a>
            </div>

            <!-- Form Pencarian & Filter -->
            <form action="<?php echo e(route('employees.index')); ?>" method="GET" class="row g-2 mb-3 align-items-center" role="search">
                <div class="col-md-3">
                    <input type="text" name="search" value="<?php echo e($search ?? ''); ?>" class="form-control form-control-sm" placeholder="Cari nama, NIP, unit, jabatan, pangkat...">
                </div>
                <div class="col-md-2">
                    <select name="status_pegawai" class="form-select form-select-sm" onchange="this.form.submit()">
                        <option value="">Semua Status Pegawai</option>
                        <?php $__currentLoopData = ['PNS', 'PPPK', 'PPPK Paruh Waktu']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="col-md-2">
                    <select name="position_id" class="form-select form-select-sm" onchange="this.form.submit()">
                        ...
                        <?php $__currentLoopData = $positions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pos): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($pos->id); ?>" <?php echo e(($positionId ?? '') == $pos->id ? 'selected' : ''); ?>>
                                <?php echo e($pos->name); ?>
                ...
                <div class="col-md-3 d-flex gap-1">
                    ...
                    <?php if(!empty($search) || !empty($statusPegawai) || !empty($statusKepegawaian) || !empty($departmentId) || !empty($positionId)): ?>
                        <a href="<?php echo e(route('employees.index')); ?>" class="btn btn-sm btn-outline-secondary" title="Reset Filter">
                ...
                <table class="table table-hover align-middle">
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $employees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $employee): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                <td>
                                    <div class="fw-bold text-dark"><?php echo e($employee->full_name); ?></div>
                                    <small class="text-muted"><i class="bi bi-person-heart me-1"></i>Usia: <?php echo e($employee->usia); ?> Thn</small>
                                </td>
                                <td><span class="badge bg-light text-dark border"><?php echo e($employee->employee_number ?: '-'); ?></span></td>
                                <td>
                                ...
                                <td><small class="fw-semibold"><?php echo e($employee->pangkat_golongan ?: '-'); ?></small></td>
                                <td><?php echo e($employee->unit_kerja ?: $employee->department->name ?? '-'); ?></td>
                                <td><small><?php echo e($employee->position->name ?? '-'); ?></small></td>
                                <td><small class="fw-bold text-primary"><?php echo e($employee->masa_kerja); ?></small></td>
                                <td>
                                ...
                                <td class="text-center">
                                    <div class="btn-group btn-group-sm" role="group">
                                        <a href="<?php echo e(route('employees.show', $employee)); ?>" class="btn btn-info text-white" title="Detail & Riwayat Kepegawaian">
                                            <i class="bi bi-eye"></i>
                                        </a>
                                        <a href="<?php echo e(route('employees.edit', $employee)); ?>" class="btn btn-warning" title="Edit Pegawai">
                                            <i class="bi bi-pencil"></i>
                                        </a>
                                        <form action="<?php echo e(route('employees.destroy', $employee)); ?>" method="POST" class="d-inline" onsubmit="return confirm('Yakin ingin menghapus pegawai ini?')">
                                            <?php echo csrf_field(); ?>
    ...
    <div class="modal fade" id="pdfExportModal" tabindex="-1" aria-labelledby="pdfExportModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="<?php echo e(route('employees.export-pdf')); ?>" method="GET" target="_blank">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\BakesBangPol\KesbangPol\resources\views/employees/index.blade.php ENDPATH**/ ?>