...
unset($__errorArgs, $__bag); ?>" required>
                        ...
                        <option value="1.3.2.02.01.02.003"
                            <?php echo e(old('kode_barang') == '1.3.2.02.01.02.003' ? 'selected' : ''); ?>>1.3.2.02.01.02.003 -
                            Kendaraan Mini Bus</option>
                        <option value="1.3.2.01.03.04.002"
                            <?php echo e(old('kode_barang') == '1.3.2.01.03.04.002' ? 'selected' : ''); ?>>1.3.2.01.03.04.002 - Portable
                            Generating Set</option>
                        <option value="1.3.2.05.01.01.001"
                            <?php echo e(old('kode_barang') == '1.3.2.05.01.01.001' ? 'selected' : ''); ?>>1.3.2.05.01.01.001 - Personal
                            Computer / Laptop</option>
                        <option value="1.3.2.05.02.01.004"
                            <?php echo e(old('kode_barang') == '1.3.2.05.02.01.004' ? 'selected' : ''); ?>>1.3.2.05.02.01.004 - Printer
                            / Scanner</option>
                    </select>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\bakesbangpol\resources\views\assets\create.blade.php ENDPATH**/ ?>